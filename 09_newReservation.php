...
//                    $getReserve = "SELECT customer.customer_id, customer_name, email, phone, customer.date, sets.set_selection, sets.order_status FROM `customer` INNER JOIN `sets` ON customer.customer_id=sets.customer_id ORDER BY".$order;
//
